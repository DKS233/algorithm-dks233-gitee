...
import class35.AvlTree.*;
import class36.SizeBalancedTree.*;
import class36.SkipList.*;
...
public class Comparator {
    ...
    public static void functionTest() {
        ...
        MySkipList<Integer, Integer> skip = new MySkipList<>();
        int maxK = 500;
        int maxV = 50000;
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            if (treeMap.size() != avl.getSize() || sbt.getSize() != skip.size() || treeMap.size() != sbt.getSize()) {
    ...
    public static void performanceTest() {
        ...
        MySkipList<Integer, Integer> skip;
        long start;
        long end;
        int max = 1000000;
        treeMap = new TreeMap<>();
